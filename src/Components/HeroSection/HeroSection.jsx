...
import { FaReact, FaBolt, FaPaintBrush, FaFacebookF, FaLinkedinIn, FaGithub, FaWhatsapp, FaArrowRight } from "react-icons/fa";
...
export default function HeroSection() {
  ...
  const socialLinks = [
    ...
    { icon: <FaFacebookF />, href: "https://www.facebook.com/hashem.hashem.56829" },
    { icon: <FaWhatsapp />, href: "https://wa.me/8801315315449" },
    { icon: <BiLogoGmail />, href: "mailto:hashemm621@gmail.com" },
  ];

  return (
    <section id="home" className="relative w-full min-h-screen flex items-center justify-center px-6 md:px-16 pt-32 pb-20 overflow-hidden bg-[#0a0a0c]">
      
      {/* Background Layer */}
      <div className="absolute inset-0 z-0">
        <div 
          className="absolute inset-0 opacity-20"
          style={{ backgroundImage: `url(${BannerBg})`, backgroundSize: "cover", backgroundPosition: "center", filter: "blur(40px)" }}
        />
      ...
      {shapes.map((shape, idx) => (
        <motion.div
          ...
          style={{ width: shape.size * 4, height: shape.size * 4, top: shape.top, left: shape.left, backgroundColor: shape.color }}
      ...
      <div className="relative z-10 container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white leading-[1.1]">
            ...
            <span className="text-3xl md:text-5xl text-gray-400">Fullstack Developer</span>
          </h1>

          <p className="text-gray-400 mt-6 text-base md:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
            I craft scalable web solutions using the <span className="text-white font-semibold">MERN Stack</span>. 
            Focused on building high-performance applications with clean code and great user experiences.
          </p>
          ...
          <div className="flex flex-wrap gap-8 my-8 justify-center lg:justify-start">
            {[
              ...
              <div key={idx} className="group">
                <p className="text-2xl font-bold text-white group-hover:text-purple-500 transition-colors">{stat.num}</p>
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
            <a href="#projects" className="px-8 py-4 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-xl transition-all shadow-[0_0_20px_rgba(168,85,247,0.4)] flex items-center gap-2 group">
              Explore Projects <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
            </a>
            <a 
        ...
        <div className="relative flex-1 flex justify-center lg:justify-end">
          ...
          >
            ...
            <div className="relative w-full h-full rounded-3xl overflow-hidden border border-gray-800 bg-[#16161a]">
              <img src={ProfileImageSrc} alt="Md Hashem" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" />
            </div>
